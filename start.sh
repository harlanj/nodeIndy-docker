...
docker run -dt -v /var/logs:logs -p 80:80 --link socketio1:socketio1 --link socketio2:socketio2 --link socketio3:socketio3 --link socketio4:socketio4 -e BACKEND_PORT=8080 tutum/haproxy